...
namespace Microsoft.VisualStudio.Project.Samples.CustomProject.UnitTests
{
	...
	public class GeneralPropertyPageTest : BaseTest
	{
		...
		{
			generalPropertyPage.TargetPlatform = PlatformType.v2;

			PlatformType expected = PlatformType.v2;
			PlatformType actual = generalPropertyPage.TargetPlatform;
		...
		{
			generalPropertyPage.TargetPlatformLocation = expected;

			string actual = generalPropertyPage.TargetPlatformLocation;
