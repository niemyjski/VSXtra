...
using DeepDiver.VSXtraCommands;
...
namespace UnitTestProject.MenuItemTests
{
  ...
  public class MenuItemTest
  {
    ...
    {
      // Create the package
      IVsPackage package = new VSXtraCommandsPackage() as IVsPackage;
      ...
      CommandID menuCommandID = new CommandID(DeepDiver.VSXtraCommands.GuidList.guidVSXtraCommandsCmdSet, (int)DeepDiver.VSXtraCommands.PkgCmdIDList.cmdidMyCommand);
